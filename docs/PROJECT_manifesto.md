# BrainTube Project Manifesto

## Core Vision
BrainTube is a curated, distraction-free YouTube experience designed for learning, productivity, and deep focus. The goal is to escape algorithmic rabbit holes by explicitly building a personalized feed of high-quality educational channels, managing them intuitively, and processing the content intelligently with AI.
...
## Roadmap
- [x] Initial Scaffolding & Channel Fetching
- [x] Categories & Filtering
- [x] AI Transcript Summarization (Groq)
- [x] API Quota Protection logic (Hourly Syncs)
